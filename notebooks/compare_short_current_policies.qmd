---
title: "Compare short current policies"
format: dashboard
#   dashboard:
#     scrolling: false
jupyter: python3
...
data_folders = [
    ...
    "26z-short-current-policies-retire",
    "26z-short-current-policies-commit-retire",
]
...
```{python}
# | title: Regional Capacity (2030)
chart = chart_total_cap(
    cap.query("planning_year==2030"),
    x_var="case",
    row_var="model",
    col_var="agg_zone",
    order=order,
...
```
```{python}
# | title: Regional Capacity (2040)
chart = chart_total_cap(
    cap.query("planning_year==2040"),
    x_var="case",
    row_var="model",
    col_var="agg_zone",
    order=order,
