---
title: "Compare current policies"
format: dashboard
jupyter: python3
categories:
    - Full
...
```{python}
# | title: Total Capacity
chart = chart_total_cap(cap, mark_type="line", x_var="planning_year", col_var="tech_type", row_var="case", color="model", order=order, width=125, height=200)
chart
```
```{python}
...
chart = chart_op_nse(op_nse, x_var="model", col_var="case", row_var="planning_year")
chart
```
